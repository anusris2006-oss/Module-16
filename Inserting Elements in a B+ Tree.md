# Ex. No: 16C - Inserting Elements in a B+ Tree in Python
...
## OUTPUT
<img width="822" height="467" alt="image" src="https://github.com/user-attachments/assets/7ba77a9a-e826-4f46-86ea-6acd3a8d02bd" />

```
```

## RESULT
Thus, the python code to insert elements into a B+ Tree is written and executed successfully.
