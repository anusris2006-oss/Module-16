...
## OUTPUT
<img width="748" height="277" alt="image" src="https://github.com/user-attachments/assets/4bce2a42-3615-445d-bc1f-4be10bc5852c" />

```
```

## RESULT
Thus, the python code to insert the nodes in a B-Tree is written and executed successfully.
